...
<div class="container">
    ...
    <div class="row justify-content-between">
        ...
        <div class="col-6">
            <table class="table table-bordered">
                ...
                <?php if($this->budget!=null){
                    ...
                    <tr class="d-flex"><td class="col-6"><?php echo $item['voce_costo']?></td><td class="col-6"><?php echo $item['budget']?></td></tr>
                    <?php }
                } ?>
        ...
        <div class="col-6">
            <div class="row ">
                <div class="col-12 border border-primary rounded">CRUSCOTTO DIPENDENTI</div>
